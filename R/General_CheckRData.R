...
#' If the file extension is not "RData", the function stops with an error message indicating an unsupported file type.
#' @param File character. The file path of the file to be checked. This can not be empty.
