...
#' @param ... additional arguments passed to the `gdata::humanReadable` function, allowing for further customization of the output format.
#' @return A character string representing the size of the file in a human-readable format.
#' @name FileSize
#' @export
#' @examples
