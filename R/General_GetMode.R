...
#' This function calculates the mode of a given numeric vector. The mode is the value that appears most frequently in the vector.
#'
#' @param v A numeric vector. It must not be NULL or empty.
#' @name GetMode
#' @references [click here](https://www.tutorialspoint.com/r/r_mean_median_mode.htm)
...
GetMode <- function(v) {
  ...
  if (is.null(v) || length(v) == 0) {
    stop("v cannot be NULL or empty")
  }
