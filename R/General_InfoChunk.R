...
#'
#'@param Message A character string representing the main message to be timestamped.  parameter is mandatory and cannot be NULL or empty.
#' @param ... Additional arguments passed to [IASDT.R::CatSep] for customizing the separators. 
#' @author Ahmed El-Gabbas
#' @return The function does not return any value but prints the message and separators to the console.
#' @name InfoChunk
#' @examples
