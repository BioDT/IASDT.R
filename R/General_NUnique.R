...
#' @source The source code of the function was copied from this [stackoverflow](https://stackoverflow.com/questions/22196078/count-unique-values-for-every-column) question.
#' @export
