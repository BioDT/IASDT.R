...
#'
#' This function extracts which climate model and scenario each file represents based on the provided URL string, time period, and additional match criteria. It is specifically designed to work with Chelsa climate data URLs.
#'
#' @param String A character string representing the URL from which to extract information.
#' @param Time A character string representing the time period to match. The special value "1981-2010" is treated as representing current climates, and the function returns "Current" for this case.
#' @param Matches A character vector of additional strings to match within the URL. The function returns these matches if they are found in the URL.
