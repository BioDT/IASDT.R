...
#     file.exists()
  ...
  Post_Path <- Model_Info2$Post_Path[[1]]
  M_Init_Path <- Model_Info2$M_Init_Path[[1]]
  M_samples <- Model_Info2$M_samples[[1]]
  M_thin <- Model_Info2$M_thin[[1]]
  M_transient <- Model_Info2$M_transient[[1]]
  M_Name_Fit <- Model_Info2$M_Name_Fit[[1]]
  Post_Aligned <- Model_Info2$Post_Aligned[[1]]
