    ...
    dplyr::mutate(
      Plot = furrr::future_pmap(
        ...
        .f = function(Coords, NFV, Species, DT) {
          ...
          Path_JPEG <- file.path(
            Path_RC, "RespCurv_Sp", paste0(FilePrefix, ".jpeg"))

          DT <- DT %>%
            dplyr::mutate(
              VariableDesc = dplyr::case_when(
                Variable == "bio4" ~ "<span style='font-size: 9pt;'><b>Bio4</b></span><br/><span style='font-size: 6pt;'>temperature seasonality</span>",
                Variable == "bio6" ~ "<span style='font-size: 9pt;'><b>Bio6</b></span><br/><span style='font-size: 6pt;'>temperature of the coldest month</span>",
                Variable == "bio8" ~ "<span style='font-size: 9pt;'><b>Bio8</b></span><br/><span style='font-size: 6pt;'>temperatures of the wettest quarter</span>",
                Variable == "bio12" ~ "<span style='font-size: 9pt;'><b>Bio12</b></span><br/><span style='font-size: 6pt;'>annual precipitation amount</span>",
                Variable == "bio15" ~ "<span style='font-size: 9pt;'><b>Bio15</b></span><br/><span style='font-size: 6pt;'>precipitation seasonality</span>",
                Variable == "bio18" ~ "<span style='font-size: 9pt;'><b>Bio18</b></span><br/><span style='font-size: 6pt;'>monthly precipitation amount of the warmest quarter</span>",
                Variable == "RoadRailLog" ~ "<span style='font-size: 9pt;'><b>Road + Rail intensity</b></span><br/><span style='font-size: 6pt;'> (log<sub>10</sub>(x + 0.1))</span>",
                Variable == "BiasLog" ~ "<span style='font-size: 9pt;'><b>Sampling intensity</b></span><br/><span style='font-size: 6pt;'> (log<sub>10</sub>(x + 0.1))</span>",
                .default = Variable),
          ...
          Coords_Label <- dplyr::if_else(
            ...
            ' Predictions without effect of spatial dependence <i>[coordinates = "i"]</i>')

          TitleTxt <- paste0(
            '<span style="font-size:10pt;"><b> Response curves of </b></span>',
            '<span style="color:blue; font-size:10pt;"><b><i>',
          ...
          SubTitleTxt <- paste0(Coords_Label, "  &mdash;&mdash;  ", NFV_Label, "</span>")

          Plot <- ggplot2::ggplot(
            data = ObsPA,
            mapping = ggplot2::aes(x = XVals, y = Pred, colour = Col)) +
            ggplot2::geom_jitter(
              shape = 16, width = 0, height = 0.02, alpha = 0.4, size = 0.5) +
            ggplot2::geom_line(
            ...
            ggplot2::geom_text(
              ...
              colour = "darkgrey", size = 2.25, vjust = 1.4, hjust = -0.05) +
          ...
          ggplot2::ggsave(
            filename = Path_JPEG, plot = Plot, width = 22, height = 14,
            dpi = 600, units = "cm")
