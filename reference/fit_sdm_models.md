...
- sdm_method:
  ...
  "gbm/gbm2", "rf/rf2", "ranger/ranger2", "cart", "rpart", "maxent",
  "mlp", "rbf", "svm/svm2", "mda/mda2", and "fda/fda2". These correspond
  to selected methods supported by the `sdm` package. For details and
  ...
  "gbm2", "mars2", "ranger2", "rf2", "svm2", "mda2", "fda2") to ensure
  consistent parameterisation and performance across models.
