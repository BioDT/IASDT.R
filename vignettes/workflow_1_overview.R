...
DT <- tibble::tribble(
  ...
  "DP_R_clc_crosswalk", "CLC", "Path to a text file containing custom cross-walk between CLC values at level 3 and their corresponding values for *EUNIS* and *SynHab* habitat types", "references/clc_crosswalk.txt",
  ...
  "DP_R_lumi_cpu", "HPC", "LUMI project number for CPU computations", "project_XXXXXXXXX",
  "DP_R_lumi_gpu", "HPC", "LUMI project number for GPU computations", "project_XXXXXXXXX",
  ...
  "DP_R_railway_interim", "Railways", "Directory path to interim railways data", "datasets/interim/railways",
  "DP_R_railway_processed", "Railways", "Directory path to processed railways data", "datasets/processed/railways",
  "DP_R_railway_raw", "Railways", "Directory path to raw railways data", "datasets/raw/railways",
  ...
  "DP_R_elter_raw", "Species distribution", "Path to `rds` file containing processed and standardized eLTER data", "references/elter_data_gbif_202X-XX-XX7.rds",
  ...
  "DP_R_hab_affinity", "Taxa information", "Path to `rds` file containing species affinity to habitat types", "references/taxon-habitat-combined_202X-XX-XX.rds",
  "DP_R_taxa_country", "Taxa information", "Path to excel file containing the number of grid cells per species and country", "references/2_taxon-status_202X-XX-XX.xlsx",
  "DP_R_taxa_easin", "Taxa information", "Path to `rds` file containing EASIN standardized taxonomy", "references/easin_taxon-list-gbif_202X-XX-XX.rds",
