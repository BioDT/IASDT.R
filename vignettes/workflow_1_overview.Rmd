...
DT <- tibble::tribble(
  ...
  "DP_R_road_interim", "Roads", "Directory path to interim roads data", "datasets/interim/roads",
  "DP_R_road_processed", "Roads", "Directory path to processed roads data", "datasets/processed/roads",
  "DP_R_road_raw", "Roads", "Directory path to raw roads data", "datasets/raw/roads",
  "DP_R_road_url", "Roads", "URL for the Global Roads Inventory Project (GRIP) data", "https://dataportaal.pbl.nl/downloads/GRIP4/GRIP4_Region4_vector_fgdb.zip",
