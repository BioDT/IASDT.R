...
- **habitat-specific modelling**: The percentage coverage of `SynHab` habitat types informs model fitting by:
  1. optionally excluding grid cells with zero coverage of the relevant habitat type during model fitting.
