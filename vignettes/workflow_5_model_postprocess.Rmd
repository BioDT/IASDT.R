...
- Response curves
  - `rc_prepare_data()` extends the functionality of `Hmsc::constructGradient()` and `Hmsc::plotGradient()` by enabling the preparation of response curve data on GPUs when `lf_commands_only = TRUE`.
